...
variacaoTempPorDia('C:\Python\Ciência de Dados\Dados INMET 2024\INMET2024.csv')
variacaoUmidade('C:\Python\Ciência de Dados\Dados INMET 2024\INMET2024.csv')
juncao_Temp_E_Umidade('C:\Python\Ciência de Dados\Dados INMET 2024\INMET2024.csv')
analisar_radiacao_e_energia('C:\Python\Ciência de Dados\Dados INMET 2024\INMET2024.csv', area_painel, eficiencia)